    ...
    if(byte_2159==0)
    {
        ...
        if(C[3]||C[5]||C[7])
        {
            if(Voltage()<10)
            {
                ...
                if(C[3])
                {
                    Velocity_control_x(0x15);
                }
                else if(C[5])
                {
                    Velocity_control_y(0x15);
                }
                else if(C[7])
                {
                    Velocity_control_z(0x15);
                }
            }
            else
            {
        ...
        else
        {
            if(Voltage()<10)
            {
                ...
                if(C[4])
                {
                    Velocity_control_x(0xffeb);
                }
                else if(C[6])
                {
                    Velocity_control_y(0xffeb);
                }
                else if(C[8])
                {
                    Velocity_control_z(0xffeb);
                }
            }
            else
            {
...
void P12(void)
{
    ...
    if(!P[12])
    {
        ...
        position_sy = YPosi(0);
        Dis_pos = 0;
        Write_spi(0x100,position_sx);
        Write_spi(0x104,position_sy);
...
void F12(void)
{
    ...
    case 8:
        ...
        if(ZPosi(0)>lhv-50/DZC)
        {
            ...
            ldv=positiond+ld/5;/*by jason ld*/
            F12_flag=4;
            ia=2;
            if(!P[3]||P[10]>1)
            {
