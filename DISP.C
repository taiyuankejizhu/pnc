...
void ShowF8(int lines){
    ...
    Dispcbar(F9X+5+40,F9Y-10+21*2,F9X+100,F9Y+5+18*2+20,0,color,1,"   分 辨 率:");
    Dispcbar(F9X+5+40,F9Y-10+21*3,F9X+100,F9Y+5+18*3+20,0,color,1,"   X 轴方向:");
    Dispcbar(F9X+5+40,F9Y-10+21*4,F9X+100,F9Y+5+18*4+20,0,color,1,"   Y 轴方向:");
    Dispcbar(F9X+5+40,F9Y-10+21*5,F9X+100,F9Y+5+18*5+20,0,color,1,"   Z 轴方向:");
    Dispcbar(F9X+5+40,F9Y-10+21*6,F9X+100,F9Y+5+18*6+20,0,color,1,"   原点清零:");
    Dispcbar(F9X+5+40,F9Y-10+21*7,F9X+100,F9Y+5+18*7+20,0,color,1,"   电    流:");
    }
}
/*修改运动顺序*/
