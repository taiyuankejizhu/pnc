...
#include <ctype.h>
static FILE *FP;
static char LN02A[90];
static struct _TAB_ tabprocon[30];
static char matile_arr[6] = {-1,-1,-1,-1,-1,-1};
static char select[80];
double CNC_atof(const char *str)   /*字符串到浮点数的转换*/
{
    double l=0;
    char *temp,*temp1,*s,*temp_s,*s_s;
    int k=10;
...
void ProcessTable(long lDeep,char cMaterial,int iCurrent,int iAcreage,char cEffect,char cShape,char cProcess,int mCurrent)
{
    ...
    for(i=0,k=0; i<cLineNumber; i++,k++)
    {
        ...
        stTemp.Dianliu[i]=CNC_atof(tabprocon[select[k]].ip);
        ...
        if(flagl[s] != -1 && flagl[s+1] != -1) /*存在加工条件*/
        {
            ...
            for(fj=flagl[s]; fj<flagl[s + 1]-82;)
            {
                ...
                for(j = 0; j<82;)
                {
                    ...
                    case 'c':
                        ii=j;
                        strncpy(tabprocon[k].no,LN02A+j,4);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].no[j-ii-2]='\0';
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }/*j++;*/while(LN02A[j]==' ')
                        ...
                        ii=j;
                        strncpy(tabprocon[k].pl,LN02A+j,2);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].pl[j-ii-1]='\0';
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].ip,LN02A+j,6);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].ip[j-ii-1]='\0';
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].on,LN02A+j,4);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].on[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].off,LN02A+j,4);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].off[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].sv,LN02A+j,4);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].sv[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].s,LN02A+j,3);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].s[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].up,LN02A+j,4);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].up[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].dn,LN02A+j,3);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].dn[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].v,LN02A+j,3);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].v[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].hv,LN02A+j,3);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        ...
                        ii=j;
                        strncpy(tabprocon[k].lc,LN02A+j,3);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].lc[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].pp,LN02A+j,3);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].pp[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].lns,LN02A+j,1);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].lns[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].step,LN02A+j,6);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].step[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].lnm,LN02A+j,4);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].lnm[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].b_ofs,LN02A+j,6);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].b_ofs[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].s_ofs,LN02A+j,6);
                        while(LN02A[j++]!=' ')
                        {
                            ;
                        }
                        tabprocon[k].s_ofs[j-ii-1]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
                        ii=j;
                        strncpy(tabprocon[k].ry,LN02A+j,5);
                        while(LN02A[j]!=' '&&LN02A[j]!=';')
                        {
                            j++;
                        }
                        tabprocon[k].ry[j-ii]=0;
                        while(LN02A[j]==' ')
                        {
                            j++;
                        }
