...
void Key(void)
{
    ...
    /*5.22 X轴添加*/
    if((F[4]<5||F[4]>6)&&!(UDK2&0x10)&&(UDK2&0x20||LFRT==2))
    {
        if(ORgin&0x80)
        {
            ShowMess(17);
    ...
    /*9.1 Y轴添加*/
    if((F[4]<5||F[4]>6)&&!(UDK3&0x10)&&(UDK3&0x20||FRBK==2))
    {
        if(ORgin&0x80)
        {
            ShowMess(17);
    ...
    if(KeyPress())
    {
        ...
        case 10:  /*参数设定*/
            ...
            case DN:
                ...
                else if(last_setline==7)
                {
                    ListStrYP(17,0,0);
                }
                else if(last_setline==8)
                {
                    ListStrZP(17,1,0);
                }
                break;
        ...
        case 12: /*放电位置设定*/
            if(Fx)
            {
                /*if(k!=aF5&&P[12]){P12();ShowKey(11,5);}*/
                switch(k)
                {
                    /*确定*/
                case aF1  :
            ...
            else
            {
                if(k==0xd) /*GetInput();*/
                {
                    ...
                    if(KeyN!=0x7fffffff)
                    {
                        ...
                        {
                        case 0:
                            Node.x_pos[YY]=KeyN/DZC;
                            break;
                        case 1:
                            Node.y_pos[YY]=KeyN/DZC;
                            break;
                        case 2:
                            Node.z_pos[YY]=KeyN/DZC;
                            break;
                        }
                        XX++;
                        j=YY;
...
void DelNode(char num)
{
    ...
    for(i=0; i<20; i++)
    {
        if(Node.flag[i]==1)
        {
            if(i>num-1)
            {
                Node.x_pos[i]=Node.x_pos[i+1];
                Node.y_pos[i]=Node.y_pos[i+1];
                Node.flag[i]=Node.flag[i+1];
            }
        }
        else
        {
